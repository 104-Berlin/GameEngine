...
#define EXEC_CONSTRUCTOR_ARGS_2(var, code) typename ::std::remove_const<typename ::std::remove_reference<decltype(var)>::type>::type var\
											EXEC_CONSTRUCTOR_ARGS_1(code)

#define EXEC_CONSTRUCTOR_ARGS_3(var, ...) typename ::std::remove_const<typename ::std::remove_reference<decltype(var)>::type>::type var,\
											EXEC_CONSTRUCTOR_ARGS_2(__VA_ARGS__)

#define EXEC_CONSTRUCTOR_ARGS_4(var, ...) typename ::std::remove_const<typename ::std::remove_reference<decltype(var)>::type>::type var,\
											EXEC_CONSTRUCTOR_ARGS_3(__VA_ARGS__)
#define EXEC_CONSTRUCTOR_ARGS_5(var, ...) typename ::std::remove_const<typename ::std::remove_reference<decltype(var)>::type>::type var,\
                                            EXEC_CONSTRUCTOR_ARGS_4(__VA_ARGS__)
#define EXEC_CONSTRUCTOR_ARGS_6(var, ...) typename ::std::remove_const<typename ::std::remove_reference<decltype(var)>::type>::type var,\
                                            EXEC_CONSTRUCTOR_ARGS_5(__VA_ARGS__)



#define EXEC_CONSTRUCTOR_ARGS_N(N, ...) CONCATENATE(EXEC_CONSTRUCTOR_ARGS_, N) (__VA_ARGS__)


#define EXEC_CONSTRUCTOR_INIT_1(code) 
#define EXEC_CONSTRUCTOR_INIT_2(var, code) this->var = var;\
											EXEC_CONSTRUCTOR_INIT_1(code)

#define EXEC_CONSTRUCTOR_INIT_3(var, ...) this->var = var;\
											EXEC_CONSTRUCTOR_INIT_2(__VA_ARGS__)

#define EXEC_CONSTRUCTOR_INIT_4(var, ...) this->var = var;\
											EXEC_CONSTRUCTOR_INIT_3(__VA_ARGS__)
#define EXEC_CONSTRUCTOR_INIT_5(var, ...) this->var = var;\
                                            EXEC_CONSTRUCTOR_INIT_4(__VA_ARGS__)
#define EXEC_CONSTRUCTOR_INIT_6(var, ...) this->var = var;\
                                            EXEC_CONSTRUCTOR_INIT_5(__VA_ARGS__)



#define EXEC_CONSTRUCTOR_INIT_N(N, ...) CONCATENATE(EXEC_CONSTRUCTOR_INIT_, N) (__VA_ARGS__)


#define E_RENDERCOMMAND(...) struct CONCATENATE(_RenderCommand_, __LINE__) : public ERenderCommand{\
							DEFINE_VAR_N(ARG_COUNT(__VA_ARGS__), __VA_ARGS__)\
                            CONCATENATE(_RenderCommand_, __LINE__) ( EXEC_CONSTRUCTOR_ARGS_N(ARG_COUNT(__VA_ARGS__), __VA_ARGS__) ) {\
                                EXEC_CONSTRUCTOR_INIT_N(ARG_COUNT(__VA_ARGS__), __VA_ARGS__)\
                            }\
                            virtual void Execute() {\
	                            EXEC_FUNCTION_N(ARG_COUNT(__VA_ARGS__), __VA_ARGS__)\
                            }\
                        };
namespace Engine {

	class E_API ERenderCommand
	{
	public:
