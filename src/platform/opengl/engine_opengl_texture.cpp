...
namespace Engine {
	...
	EOpenGLTexture2D::EOpenGLTexture2D(const EString& enginePath, ETextureFormat format, u32 width, u32 height)
		: ETexture2D(enginePath), fFormat(format), fWidth(width), fHeight(height), fRendererID(0)
	{
		IN_RENDER_S({
